			...
			<div class="single-grids">				
				<div class="col-md-4 single-grid">		
					<div class="flexslider">
						<ul class="slides">	
							<li data-thumb="images/${cakedetail.bigimg }">
								<div class="thumb-image"> <img src="images/${cakedetail.bigimg }" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="images/${cakedetail.bigimg }">
								 <div class="thumb-image"> <img src="images/${cakedetail.bigimg }" data-imagezoom="true" class="img-responsive"> </div>
							</li>
				...
				<div class="col-md-4 single-grid simpleCart_shelfItem">		
					<h3>${cakedetail.name}</h3>
					<p>${cakedetail.digest }</p>
					<ul class="size">
						<h3>Size</h3>
							<li><a href="#">${cakedetail.size }</a></li>		
					</ul>
					
					<div class="galry">
						<div class="prices">
							<h5 class="item_price">${cakedetail.price}</h5>
						</div>
						<div class="rating">
						<c:forEach var="i" begin="1" end="${cakedetail.level }">
							<span>☆</span>
						</c:forEach>
						</div>
					...
					<div class="btn_form">
						<a href="AddCartServlet?id=${cakedetail.id }" class="add-cart item_add">ADD TO CART</a>	
					</div>
					<div class="tag">
						<p>Category : <a href="#"> Cakes</a></p>
						<p>Tag : <a href="#"> ${cakedetail.tag} </a></p>
					</div>
				</div>
